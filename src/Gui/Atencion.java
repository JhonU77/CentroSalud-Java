...
public class Atencion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bttExportarPdf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/pdf (1).png"))); // NOI18N
    ...
    private void MostrarCitas() {
        ...
        try (Connection con = Conexion.getConexion();
            ...
            while (rs.next()) {
                ...
                fila[0] = rs.getInt("ID_Cita"); // Oculto
                fila[1] = rs.getString("DNI_Paciente"); // Oculto
